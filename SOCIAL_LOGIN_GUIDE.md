...
**중요**: 개인 개발자도 모든 플랫폼에서 소셜 로그인을 구현할 수 있습니다. 사업자 등록증 없이도 시작할 수 있습니다.

### 플랫폼별 개인 개발자 가능 여부 요약

| 플랫폼 | 개인 개발자 가능 | 사업자 등록증 필요 | 비고 |
|--------|----------------|------------------|------|
| **구글** | ✅ 가능 | ❌ 불필요 | 가장 개방적, 추천 |
| **네이버** | ✅ 가능 | ❌ 불필요 | 개인 신분증만으로 가능 |
| **카카오** | ✅ 가능 | ⚠️ 선택적 | 일반 앱은 가능, 비즈앱 전환 시 필요 |
| **페이스북** | ✅ 가능 | ❌ 불필요 | 개발 모드로 자유롭게 가능 |
| **인스타그램** | ✅ 가능 | ❌ 불필요 | 페이스북 개발자 플랫폼 사용 |

> 💡 **권장**: 개인 프로젝트/포트폴리오는 개인 개발자로 시작 가능하며, 상업적 서비스는 사업자 등록 후 신청하는 것을 권장합니다.
...
#### 1.1 사업자 관련 서류
- **사업자 등록증** (법인 또는 개인사업자인 경우)
  - 사업자등록번호 확인
  - 사업자등록증 사본 (PDF 또는 이미지)
  - 형식: JPG, PNG, PDF
  - 크기: 10MB 이하
  - **참고**: 개인 개발자는 일반 앱으로 시작 가능 (비즈앱 전환 시 필요)
...
### 개인 개발자 안내
- ✅ **개인 개발자도 가능**: 개인 신분증만으로 일반 앱 생성 가능
- ⚠️ **비즈앱 전환**: 이메일 등 필수 동의 항목이 필요하면 비즈앱 전환 필요 (사업자 등록증 필요)
- 💡 **권장**: 개인 프로젝트는 일반 앱으로 시작, 필요시 비즈앱 전환
...
### 개인 개발자 안내
- ✅ **개인 개발자도 가능**: 사업자 등록증 없이 개인 신분증만으로 신청 가능
- 💡 **권장**: 개인 개발자에게 가장 접근하기 쉬운 플랫폼 중 하나
...
6. **검증 상태 확인**
   ...
   - 검증되지 않은 앱은 경고 표시 (사용자는 계속 사용 가능)

### 개인 개발자 안내
- ✅ **개인 개발자도 가능**: 가장 개방적인 플랫폼, 사업자 등록증 불필요
- 💡 **권장**: 개인 개발자에게 가장 추천하는 플랫폼
- ⚠️ **참고**: 검증되지 않은 앱 경고가 표시되지만 기능은 정상 작동
...
- **사업자 등록증** (선택사항)
  ...
  - 사업자등록증 사본
  - 형식: PDF, 이미지
  - **참고**: 개인 개발자는 개인 Facebook 계정으로 앱 생성 가능
...
### 개인 개발자 안내
- ✅ **개인 개발자도 가능**: 개인 Facebook 계정으로 앱 생성 가능
- ⚠️ **앱 심사**: 공개 배포 시 앱 심사 필요 (1-7일)
- 💡 **권장**: 개발/테스트는 자유롭게 가능, 상업적 서비스는 비즈니스 계정 권장
...
### 개인 개발자 안내
- ✅ **개인 개발자도 가능**: 개인 Facebook 계정으로 앱 생성 가능
- ⚠️ **개발 모드**: 개발 모드에서는 개발자 및 테스터만 사용 가능
- ⚠️ **앱 심사**: 공개 배포 시 앱 심사 필요
- 💡 **권장**: 개발/테스트는 자유롭게 가능, 공개 배포 시 심사 필요
...
#### 서류 준비
- [ ] **개인 개발자인 경우**:
  - [ ] 개인 신분증 준비 (주민등록증 또는 운전면허증)
  - [ ] 사업자 등록증 불필요 (대부분의 플랫폼)
- [ ] **법인/개인사업자인 경우**:
  - [ ] 사업자 등록증 준비
  - [ ] 대표자 신분증 준비
...
**중요**: 개인 개발자도 모든 플랫폼에서 소셜 로그인을 구현할 수 있습니다. 다만 플랫폼별로 제한사항이 있습니다.

#### 플랫폼별 개인 개발자 가능 여부 및 제한사항

##### 카카오 로그인
- ✅ **개인 개발자 가능**
- ⚠️ **제한사항**:
  - 일반 앱: 기본적인 로그인 기능 사용 가능
  - 비즈앱 전환: 이메일 등 필수 동의 항목 설정을 위해 비즈앱 전환 필요
  - 비즈앱 전환 시: 사업자 등록증 필요 (개인사업자도 가능)
  - 상업적 서비스: 사업자 등록 권장
- **권장**: 개인 프로젝트/포트폴리오는 일반 앱으로도 충분, 상업적 서비스는 비즈앱 전환 권장
...
- ⚠️ **제한사항**:
  - 사업자 등록증 없이도 신청 가능
  - 개인 신분증으로 신청 가능
  - 상업적 서비스의 경우 사업자 등록 권장
- **권장**: 개인 개발자도 자유롭게 사용 가능

##### 구글 로그인
- ✅ **개인 개발자 가능** (가장 개방적)
- ⚠️ **제한사항**:
  - 사업자 등록증 불필요
  - 개인 Google 계정으로 바로 시작 가능
  - OAuth 동의 화면에서 "외부" 사용자 유형 선택
  - 검증되지 않은 앱 경고 표시 (사용자는 계속 사용 가능)
- **권장**: 개인 개발자에게 가장 추천하는 플랫폼

##### 인스타그램 로그인
- ✅ **개인 개발자 가능**
- ⚠️ **제한사항**:
  - Facebook 개발자 계정으로 관리
  - 개인 Facebook 계정으로 앱 생성 가능
  - 앱 심사 시 비즈니스 정보 요구 가능
  - 상업적 서비스는 비즈니스 계정 권장
- **권장**: 개인 프로젝트는 가능, 상업적 서비스는 비즈니스 계정 권장

##### 페이스북 로그인
- ✅ **개인 개발자 가능**
- ⚠️ **제한사항**:
  - 개인 Facebook 계정으로 앱 생성 가능
  - 개발 모드에서는 개발자 및 테스터만 사용 가능
  - 공개 배포 시 앱 심사 필요
  - 앱 심사 시 비즈니스 정보 요구 가능
  - Facebook 정책 준수 필수
- **권장**: 개발/테스트는 자유롭게 가능, 공개 배포 시 심사 필요
...
- ✅ **서비스 정보**: 서비스명, URL, 로고 등
- ✅ **법적 문서**: 개인정보 처리방침, 이용약관
- ❌ **사업자 등록증**: 대부분 불필요 (상업적 서비스 제외)

##### 상업적 서비스인 경우
- ⚠️ **사업자 등록 권장**: 수익을 목적으로 하는 서비스
- ⚠️ **플랫폼별 정책**: 각 플랫폼의 상업적 이용 정책 확인 필요
...
#### 권장사항
- **개인 프로젝트/포트폴리오**: 개인 개발자로 시작 가능
- **상업적 서비스**: 사업자 등록 후 신청 권장
- **시작은 개인으로, 필요시 전환**: 처음엔 개인 개발자로 시작하고, 필요시 사업자 등록 후 업그레이드 가능
